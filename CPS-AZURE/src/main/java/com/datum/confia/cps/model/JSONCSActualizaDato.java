...
public class JSONCSActualizaDato {
	...
	*/
	...
	public String toString() {
		return "JSONCSActualizaDato [idActualizacion=" + idActualizacion + ", fechaActualizacion=" + fechaActualizacion
				+ ", tipoDocumentoAd=" + tipoDocumentoAd + ", nit=" + nit + ", numId=" + numId + ", fechaNacimientoAd="
				+ fechaNacimientoAd + ", nup=" + nup + ", nombreNew=" + nombreNew + ", nombreOld=" + nombreOld
				+ ", primerNombreOld=" + primerNombreOld + ", primerNombreNew=" + primerNombreNew
				+ ", segundoNombreOld=" + segundoNombreOld + ", segundoNombreNew=" + segundoNombreNew
				+ ", primerApellidoOld=" + primerApellidoOld + ", primerApellidoNew=" + primerApellidoNew
				+ ", segundoApellidoOld=" + segundoApellidoOld + ", segundoApellidoNew=" + segundoApellidoNew
				+ ", apellidoCasadaNew=" + apellidoCasadaNew + ", apellidoCasadaOld=" + apellidoCasadaOld
				+ ", telefono1Old=" + telefono1Old + ", telefono1New=" + telefono1New + ", telefono2New=" + telefono2New
				+ ", telefono2Old=" + telefono2Old + ", tipoDocumentoOld=" + tipoDocumentoOld + ", tipoDocumentoNew="
				+ tipoDocumentoNew + ", numeroDocumentoOld=" + numeroDocumentoOld + ", numeroDocumentoNew="
				+ numeroDocumentoNew + ", fechaNacimientoOld=" + fechaNacimientoOld + ", fechaNacimientoNew="
				+ fechaNacimientoNew + ", correo1Old=" + correo1Old + ", correo1New=" + correo1New + ", correo2Old="
				+ correo2Old + ", correo2New=" + correo2New + ", indEstadoRegistroOld=" + indEstadoRegistroOld
				+ ", indEstadoRegistroNew=" + indEstadoRegistroNew + ", estadoAfiliadoOld=" + estadoAfiliadoOld
				+ ", estadoAfiliadoNew=" + estadoAfiliadoNew + ", estado=" + estado + ", adicionadoPor=" + adicionadoPor
				+ ", fechaIngresado=" + fechaIngresado + ", fechaProcesado=" + fechaProcesado + ", fechaModificado="
				+ fechaModificado + ", modificadoPor=" + modificadoPor + ", fuente=" + fuente + ", usuarioWebOld="
				+ usuarioWebOld + ", usuarioWebNew=" + usuarioWebNew + ", valid=" + valid + ", idAad=" + idAad
				+ ", reproceso=" + reproceso + ", mensaje=" + mensaje + "]";
	}
